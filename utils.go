...
//
// This function reads a JSON file containing a Tree-sitter parse tree
// and deserializes it into a TreeSitterNode structure. The JSON file
// should be generated by tree-sitter's parse command with JSON output.
//
// Parameters:
//   - filename: Path to the JSON file containing the tree-sitter CST
//
// Returns:
//   - *TreeSitterNode: The deserialized tree-sitter node
...
//
// This function reads JSON data from the provided reader and deserializes
// it into a TreeSitterNode structure. This is useful when you have the
// tree-sitter JSON data from a source other than a file.
//
// Parameters:
//   - r: A reader containing JSON data for a tree-sitter CST
//
// Returns:
//   - *TreeSitterNode: The deserialized tree-sitter node
//   - error: An error if the reader is nil or JSON parsing fails
...
//
// This function serializes a UAST structure to JSON format with pretty-printing
// and writes it to the specified file. The output file can be loaded later
// or used for inspection and debugging.
//
// Parameters:
//   - uast: The UAST structure to save
//   - filename: Path to the output file
//
// Returns:
//   - error: An error if the UAST is nil, file cannot be created, or encoding fails
...
//
// This function takes a UAST and a formatter implementation (e.g., JSONFormat,
// SimpleTextFormat, or TreeFormat) and produces a string representation
// optimized for consumption by Large Language Models.
//
// Parameters:
//   - uast: The UAST to format
//   - format: An implementation of the LLMFormat interface
//
// Returns:
//   - string: The formatted UAST as a string
//   - error: An error if the UAST or formatter is nil, or formatting fails
